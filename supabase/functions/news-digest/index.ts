...
const ASSETS: Record<string, { name: string; currency: string; price: number; }> = {
  ...
  MMARS:  { name: "SAMAS Money Market ARS", cat: "FCI", currency: "ARS", price: 100.42 },
  MMUSD:  { name: "SAMAS Money Market USD", cat: "FCI", currency: "USD", price: 102.18 },
  RFAR:  { name: "SAMAS Renta Fija", cat: "FCI", currency: "USD", price: 105.83 },
  MIXTO:  { name: "SAMAS Mixta", cat: "FCI", currency: "USD", price: 112.4 },
  EQUITY:  { name: "SAMAS Renta Variable", cat: "FCI", currency: "USD", price: 128.95 },
  IBIT:  { name: "iShares Bitcoin Trust", cat: "CEDEAR", currency: "USD", price: 62.4 },
  COIN:  { name: "Coinbase", cat: "CEDEAR", currency: "USD", price: 247.3 },
  MSTR:  { name: "MicroStrategy", cat: "CEDEAR", currency: "USD", price: 358.4 },
  MARA:  { name: "Marathon Digital", cat: "CEDEAR", currency: "USD", price: 18.2 },
  RIOT:  { name: "Riot Platforms", cat: "CEDEAR", currency: "USD", price: 11.85 },
